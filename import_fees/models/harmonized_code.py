...
class CustomsFees(models.Model):
    ...
    state = fields.Selection(related='landed_costs_id.state', string='Status', readonly=True)
    ...
    amount = fields.Monetary("Customs Duties", currency_field='local_currency_id', digits='Product Price')
    ...
    @api.onchange('cif_value', 'eic_value', 'pal_value', 'surcharge_value', 'cid_value', 'exm_value', 'com_value', 'cess_levy_value', 'excise_duty_value', 'ridl_value', 'srl_value', 'sscl_value', 'vat_value')
