...

{
	...
	""",
    "author": "BROWSEINFO",
    "website": "https://www.browseinfo.com/demo-request?app=pos_disable_payments&version=17&edition=Community",
    "price": 20,
    "currency": 'EUR',
    "depends": ['base', 'point_of_sale', 'pos_hr','pos_discount','pos_restaurant'],
    "data": [
    ...
    "auto_install": False,
    "installable": True,
    'live_test_url': 'https://www.browseinfo.com/demo-request?app=pos_disable_payments&version=17&edition=Community',
