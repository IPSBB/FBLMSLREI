...
class StockLandedCost(models.Model):
    ...
    def _compute_total_duty(self):
        for record in self:
            record.customs_value = sum(it.amount for it in record.customs_fees_ids)
    ...
    def _compute_total_vat(self):
        for record in self:
            record.customs_vat_value = sum(it.vat_value for it in record.customs_fees_ids)
    ...
    @api.depends('customs_fees_ids.cif_value',
                 'customs_fees_ids.eic_value',
                 'customs_fees_ids.pal_value',
                 'customs_fees_ids.surcharge_value',
                 'customs_fees_ids.cid_value',
                 'customs_fees_ids.exm_value',
                 'customs_fees_ids.com_value',
                 'customs_fees_ids.cess_levy_value',
                 'customs_fees_ids.excise_duty_value',
                 'customs_fees_ids.ridl_value',
                 'customs_fees_ids.srl_value',
                 'customs_fees_ids.sscl_value',
                 'customs_fees_ids.vat_value'
                 )
...
class RecalculateWizard(models.TransientModel):
    ...
    def action_recalculate(self):
        ...
        self.landed_cost_id._compute_customs_duties()
